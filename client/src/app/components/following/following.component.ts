...
export class FollowingComponent implements OnInit {
  ...
  ngOnInit() {
  	//console.log("Componente de following arrancado");
  	this.actualPage();
  }
  	...
  	this._followService.getFollowing(this.token, userId, page).subscribe(
        ...
        //console.log(response);
          ...
          //console.log(response);
  				...
  				this.total = response.TotalFollows;
  				this.pages = response.TotalFollowsPages;
  				this.followThem = response.value.following;
  				this.status = 'success';
  				//console.log(response);
  				if(page > this.pages) {
